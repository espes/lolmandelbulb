...
function tileURL( x, y, zoom ) {
    ...
    var tilename = prefix + center.x + "-" + center.y + "-" + zoom + suffix + "." + fileType + getString; //+ "?width=512&height=512&colourmap=6";
...
function setupTileViewer( canvasId, infoId ) {
    ...
    imageCache = new LRUCache( 1024, imageLoader );
...
$(document).ready(function() {
    ...
    $("#tileViewer").html('<canvas id="viewerCanvas" width="800" height="600"></canvas><div id="viewerInfo"></div><button type="button" class="controlButton" id="zoomIn">+ ENHANCE</button><button type="button" class="controlButton" id="zoomOut">- ABSTRACT</button>');
    $(document.body).append('<style>h1 {color: #fff; size: 24pt;} #tileViewer { width: 1045px; height: 600px; } body { font-family:monospace; background:black; color: #893; } .controlButton { min-width:75px; color: #bbb; font-family:monospace; font-size: 10px; border:1px solid #888; background-color: #444; border-radius: 4px; text-align:left; } .controlButton:hover { background-color: #565; } .controlButton:active { border-color: #ccc; color: #eee; } .info { color: #bbb; font-family:monospace; font-size: 10px; border:1px solid #888; background-color: #444; border-radius: 2px; } .container { border-radius: 5px; border:1px solid #666; padding:5px; background-color: #333; }</style>');
